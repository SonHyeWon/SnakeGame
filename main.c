/*
*
* 2020-1 Sejong University OSS Team 5
*	   SIMPLE SNAKE GAME
*
* Original Project : https://github.com/dzutrinh/CLI-Snake
* Our Clean Code Project : https://github.com/SonHyeWon/SnakeGame
* 
* Contributors : SonHyeWon, mellime, hongyj9823, MtNight
* 
* todo: Multiple if statements used in do-while loop.
* HACK: Fruits are generated by overlapping with snake's body.
* 
*/
